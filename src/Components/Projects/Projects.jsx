    ...
    <section id="project">
      ...
      <div className="project-images">
        ...
        <div>
          ...
          <a href="https://rad-chaja-917c26.netlify.app/" target="_blank" rel="noreferrer">
      ...
      <div className="project-images">
        <div>
          ...
          <a
            ...
            rel="noreferrer"
          >
            <button id="aTag1A">View Live</button>
          </a>
      ...
      <div className="project-images">
        ...
        <div>
          ...
          <a href="https://creative-profiterole-43487b.netlify.app/" target="_blank" rel="noreferrer">
            <button id="aTag1">View Live</button>
          </a>
      ...
      <div className="project-images">
        <div>
          <h2 className="AdvanceAutoPart-title">
            Advance AutoPart Clone
          </h2>
          <h4 className="airgarage-header">
            Advance AutoPart plays a very crucial part for your vehicles. A website that cares for your vehicle and 
             offers parts of auto-mobile brands from 
            all over the world. 
          </h4>
          <br />
          <h6 style={{marginLeft:"50px"}}>
          ...
          <h3 id="header2">Tech Stack Used</h3>
          <a
            href="https://majestic-cobbler-7ab732.netlify.app/"
            target="_blank"
            rel="noreferrer"
          >
            <button id="aTag1Advance">View Live</button>
          </a>
          ...
          />
          <img
            style={{ width: "40px", height: "40px", marginLeft: "5px", marginRight:"20px" }}
          ...
          <a
            ...
            href="https://github.com/sandeepprogrammer64/Advance_AutoPart-Clone"
            target="_blank"
            rel="noreferrer"
          >
            <button id="aTag2Advance">View Code</button>
          </a>
        </div>

        <div>
          <img src="AdvanceAutoPartGIF.gif" alt="" />
        </div>
      </div>
